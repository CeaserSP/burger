...
## <a name="live"></a>Live
https://serene-woodland-83426.herokuapp.com/
...
If you don't want to set up this project locally and just want to see the deployed application, go to  https://serene-woodland-83426.herokuapp.com/
...
<pre>
  git clone https://github.com/CeaserSP/burger.git
  cd burger
</pre>
...
<li>
  ...
  <img src="./public/img/burgers_table.png">
...
<p>To verify that the server has started and the application is working locally on your computer, open Chrome and go to <a href="http://localhost:3306">http://localhost:3306</a>.</p>
...
<p>If you find an issue while using the app or have a request, <a href="https://github.com/CeaserSP/burger/issues" target="_blank">log the issue or request here</a>. These issues will be addressed in a future code update.</p>
